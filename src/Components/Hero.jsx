function Hero(){
    ...
    return(
        ...
        <section className=" border-y">
            <p className=" text-center sm:text-right italic font- bold md:text-[2rem] text-white text-2xl">Igniting a Revolution in HR Innovation<svg className="ml-80" width="255" height="17" viewBox="0 0 255 17" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className=" flex-col sm:w-1/2 p-8 justify-center">
                ...
                <p className="text-[0.8125rem] w-[90%] md:w-full md:text-lg leading-loose-light md:leading-loose-light max-w-[470px] mx-auto lg:mx-0 mb-8 md:mb-10 lg:mb-14 text-white pb-8 text-center sm:text-left">Participate in getlinked tech Hackathon 2023 stand 
